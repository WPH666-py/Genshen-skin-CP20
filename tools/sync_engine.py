...
背景
----
CP1(Genshen-Skin-CP1 · 散兵×荧)先做出来, 引擎代码直接放在
...
def _role_of(key):
    ...
    return {"CP2": "odette_voj", "CP3": "cp3_trio",
            ...
            "CP15": "cp15_pair", "CP16": "cp16_pair", "CP17": "cp17_quartet", "CP18": "cp18_pair", "CP19": "cp19_pair",
            "CP20": "cp20_pair"}.get(key)
...
def normalize(text, src_slug, dst_slug, dst_key=None, src_key=None, src_repo=None,
    ...
    还要改写「常量模块」的导入, 各套件结构不同:
      ...
      CP4: from ..characters import cp20_pair as C
    ...
    CN = {
        "CP1": ("原神 CP 壁纸套件 1", "原神CP1", "散兵 × 荧", "~/.genshin-cp1"),
        "CP2": ("原神 CP 壁纸套件 2", "原神CP2", "散兵 × 荧", "~/.genshen-cp2"),
        "CP3": ("原神 CP 壁纸套件 3", "原神CP3", "散兵 × 荧", "~/.genshen-cp3"),
        "CP4": ("原神 CP 壁纸套件 20", "原神CP20", "散兵 × 荧", "~/.genshen-cp20"),
    }
    ...
    # 注意: 源与目标的角色模块名可能不同(cp20_pair vs odette_voj),
